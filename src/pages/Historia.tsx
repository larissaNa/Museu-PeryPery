    ...
    <div className="min-h-screen bg-museum-dark">
      ...
      {timeline.length > 0 && (
        <section className="museum-dark-section museum-section">
          <div className="museum-container max-w-4xl">
            <div className="text-center mb-12">
              <h2 className="museum-heading text-primary-foreground mb-4">
                Marcos <span className="text-gradient">Recentes</span>
              </h2>
              <p className="museum-subheading text-museum-warm-gray">
                Acontecimentos importantes do museu ao longo do tempo.
              </p>
            </div>
            <div className="space-y-6">
              {timeline.map((ev) => (
                <div key={ev.id} className="museum-card flex gap-4">
                  <div className="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-museum-orange to-museum-gold flex items-center justify-center text-primary-foreground font-display font-bold">
                    {ev.year}
                  </div>
                  <div>
                    <h3 className="text-lg font-display font-semibold text-card-foreground mb-1">{ev.title}</h3>
                    {ev.description && (
